    ...
    <div className="w-full flex-1 min-h-screen bg-background flex flex-col">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="grid grid-cols-2 gap-5">
              <FormField label="Assign Role">
                <select
                  className="bg-sidebar border border-white/10 h-14 w-full px-5 rounded-xl text-xs font-bold text-white outline-none focus:border-primary/40 appearance-none transition-all shadow-inner"
                  value={form.role || ''}
      ...
      <div className="p-8 sm:p-12 flex justify-center bg-panel border-t border-border">
        ...
        >
          ...
          <span className="text-[11px] font-bold text-white opacity-80 group-hover:opacity-100 transition-opacity whitespace-nowrap">Return to Workspace</span>
        </button>
      </div>
