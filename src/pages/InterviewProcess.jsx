        ...
        <div className="w-full relative z-20 px-4 sm:px-8 lg:px-12 mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-row sm:flex-col items-center sm:items-end gap-3 sm:gap-1 bg-white/[0.02] sm:bg-transparent px-4 py-2 sm:p-0 rounded-xl border border-white/5 sm:border-0">
              <p className="text-[9px] sm:text-[11px] text-muted font-bold opacity-60 tracking-widest">Total Candidates</p>
            ...
            <div className="p-4 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-5xl mx-auto">
              {filteredHiring.length > 0 ? (
                  ...
                  <div key={h.id} className="group bg-sidebar/30 hover:bg-sidebar/50 border border-white/5 rounded-xl p-5 sm:p-6 space-y-5 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 active:scale-[0.99] relative overflow-hidden ring-1 ring-white/5">
                      ...
                      <div className="flex items-center gap-4 sm:gap-5">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <span className={cn(
                              "text-[9px] font-bold px-2 py-0.5 rounded border tracking-tighter",
                          ...
                          <p className="text-white font-bold text-base sm:text-lg tracking-tight leading-tight line-clamp-1">{h.candidateName}</p>
                          <p className="text-[10px] text-muted font-bold tracking-widest opacity-60 mt-2">{h.role}</p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-black/20 backdrop-blur-3xl border border-white/5 rounded-xl p-3 group-hover:border-primary/20 transition-all duration-500">
                        <p className="text-[9px] text-muted font-bold opacity-50 tracking-widest leading-none mb-1">Contact</p>
                        <div className="flex items-center gap-2 text-white/80 font-bold text-xs tracking-tighter tabular-nums truncate">
                          <Phone size={12} className="text-muted/40 shrink-0" />
                          <span>{h.phone}</span>
                        </div>
                      </div>
                      <div className="bg-black/20 backdrop-blur-3xl border border-white/5 rounded-xl p-3 group-hover:border-primary/20 transition-all duration-500">
                        <p className="text-[9px] text-muted font-bold opacity-50 tracking-widest leading-none mb-1">Applied On</p>
                        <div className="flex items-center gap-2 text-white/80 font-bold text-xs tracking-tighter tabular-nums truncate">
                ...
                <div className="py-24 flex flex-col items-center justify-center text-center px-6">
                  ...
                  <p className="text-[12px] text-muted font-bold mt-2 opacity-50 max-w-[240px] leading-relaxed">
        ...
        <div className="space-y-6 my-4 px-1">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <FormField label="Phone No">
              <input 
                className="bg-sidebar border border-white/10 h-14 w-full px-5 rounded-xl text-xs font-bold text-white outline-none focus:border-primary/40 transition-all shadow-inner tabular-nums" 
                value={form.phone || ''} 
