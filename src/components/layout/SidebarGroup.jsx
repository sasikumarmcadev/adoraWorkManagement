...
export default function SidebarGroup({ title, children, isOpen, onToggle, collapsed }) {
  ...
  return (
    <div className="mb-2">
      <button 
        onClick={onToggle}
        className={`w-full flex items-center px-5 py-2 group hover:bg-white/5 transition-colors justify-between`}
      >
